...
class MessageItemUser extends Component {
  render() {
    ...
    if (this.props.usernamefriend == sessionStorage.getItem('user_friend') && this.props.userName == sessionStorage.getItem('user_login')) {
      return (
    ...
    } else if (this.props.usernamefriend == sessionStorage.getItem('user_login') && this.props.userName == sessionStorage.getItem('user_friend')) {
      return (
        <li className={this.props.user ? "left clearfix" : "right clearfix"}>
          <span className="chat-img pull-left">
            <img src="https://bootdey.com/img/Content/user_3.jpg" alt="User Avatar" />
